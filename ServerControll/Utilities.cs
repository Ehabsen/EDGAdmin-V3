...
namespace ServerControll
{
    public partial class MyAdmin
    {
        ...
        {
            { "Spree_Headshot", "^7: ^5<attacker> ^7killed ^1<victim> ^7by Headshot!"},
            { "Spree_Kills_5", "^7: Nice spree, ^5<attacker> ^7got 5 kills in a row!"},
            { "Spree_Kills_10", "^7: Nice spree, ^5<attacker> ^7got 10 kills in a row!"},
            { "Spree_Ended", "^7: ^1<victim>^7's killing spree ended! (^1<killstreak> kills^7). He was killed by ^5<attacker>!"},
            { "Spree_Explosivekill", "^7: ^1<victim> ^7has exploded!"},
            { "Spree_Trophykill", "^7: ^5<attacker> ^7killed ^1<victim> ^7by Trophy!"},
            { "Spree_KnifeKill", "^7: ^5<attacker> ^7humiliated ^1<victim>!"}
        };
        ...
        {
            public static string ConfigPath = @"scripts\MyAdmin\";
        }
    ...
    public static class WriteLog
    {
        ...
        public static string GetClantag(this Entity player)
        {
            if (player == null || !player.IsPlayer)
                return null;
            int address = MyAdmin.Data.ClantagPlayerDataSize * player.GetEntityNumber() + MyAdmin.Data.ClantagOffset;
            return MyAdmin.Mem.ReadString(address, 8);
        }
