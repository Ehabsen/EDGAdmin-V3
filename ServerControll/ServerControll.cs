namespace ServerControll
{
    ...
    public class ServerControll : BaseScript
    {
        ...
        internal static bool bool_27 = true;
        ...
        internal static bool bool_47 = false;
        ...
        public static int Colorlvl09 = 1;
        ...
        internal static string string_10 = "^5IN^7FEC^5TED";
        ...
        internal static string string_11 = "cardicon_pacifier_blue";
        internal static string string_12 = "cardicon_pacifier_pink";
        internal static string string_13 = "cardicon_kitten";
        internal static string string_14 = "cardicon_devilfinger";
        internal static string string_15 = "null";
        internal static string string_16 = "null";
        internal static string string_17 = "^7MyAdmin v4.1 by ^5MH11 ^7- Info: ^1www.naabclub.ir";
        internal static string string_18 = "kill";
        internal static string string_19 = "tempban";
        internal static string string_2 = "plusmw3";
        internal static string string_20 = "http://naabclub.ir/";
        ...
        internal static string string_24 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_25 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_26 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_27 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_28 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_29 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_3 = "null";
        internal static string string_30 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_31 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_32 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        internal static string string_33 = "^5<playername> ^7welcome to the ^1<nameclan> ^7Server!";
        ...
        internal static string string_38 = "^5<playername> ^7is ^1AFK ^7or is a Camper!";
        ...
        internal static string string_41 = "^7Your NickName in BlackList... ^1You Can't Join!";
        internal static string string_42 = "^7Your ClanTag in BlackList... ^1You Can't Join!";
        ...
        internal static string string_45 = "MyAdmin";
        ...
        internal static string string_6 = "wWw.NaaBClub.iR";
        ...
        private static string string_69 = "http://naabclub.ir/";
        internal static string string_7 = "^7TEAM ^5B";
        internal static string string_70 = "http://naabclub.ir/";
        ...
        internal static string string_8 = "^7TEAM ^1A";
        ...
        internal static string string_9 = "^1SUR^7VIV^1ORS";
        ...
        public static string Taglvl01 = "^7[LvL^101^7]";
        public static string Taglvl02 = "^7[LvL^102^7]";
        public static string Taglvl03 = "^7[LvL^103^7]";
        public static string Taglvl04 = "^7[LvL^104^7]";
        public static string Taglvl05 = "^7[LvL^105^7]";
        public static string Taglvl06 = "^7[LvL^106^7]";
        public static string Taglvl07 = "^7[LvL^107^7]";
        public static string Taglvl08 = "^7[LvL^108^7]";
        public static string Taglvl09 = "^7[LvL^109^7]";
        ...
        public static string xStrComandilvl00 = "!info,!list,!pm,!login,!access,!afk,!suicide,!admins,!time,!rules,!ver,!votemap,!votemod,!votekick,!voteban,!y,!n,!fov,!iamgod,!report,!nextmap,!register,!xlrstats,!xlrtopstats,!help,!fps";
        public static string xStrComandilvl01 = "!banlist,!team,!fast,!map,!balance,!mteam,!ateam";
        public static string xStrComandilvl02 = "!ft,!maprotate,!restart,!alias,!mod";
        ...
        private void CreatePlayerHUD(Entity player)
        {
            ...
            KillstreakHUD.SetText("^7KILLSTREAK: ^1");
            ...
            OnInterval(300, () =>
            {
                ...
                {
                    NoKills.SetText("^1" + player.GetField<int>("killstreak").ToString());
                }
                return true;
            });
        }
        ...
        public string lookupIP(string ip)
        {
            try
            {
                ...
                if (location != null)
                {
                    ...
                    {
                        str = "^5" + location.city + "^7/^5" + location.countryName;
                    }
                    else
                    {
        ...
        {
           return ("^7You have ^1" + player.GetField<int>("TimePass") + " ^7seconds to enter the password!");
        }
        ...
        private void method_10(Entity entity_0, string string_106, int int_31)
        {
            if (System.IO.File.Exists(string_88 + string_57))
            {
                ...
                Label_00A4:
                    ...
                    Class75.smethod_73(this, entity_0, "^7Player ^1" + strArray2[0] + "^7[^1" + strArray2[1] + "^7] successfully TempBanned!");
                Label_0167:
                    if (flag)
                    {
                        break;
        ...
        private void method_11(Entity entity_0, string string_106)
        {
            if (System.IO.File.Exists(string_88 + string_57))
            {
                ...
                Label_00A4:
                    ...
                    Class75.smethod_73(this, entity_0, "^7Player ^1" + strArray2[0] + "^7[^1" + strArray2[1] + "^7] successfully Banned!");
                Label_0139:
                    if (flag)
                    {
                        break;
        ...
        internal void method_12(Entity entity_0, string string_106)
        {
            using (StreamWriter writer = new StreamWriter(string_85 + string_62, true))
            {
                string str = string.Concat(new object[] { 
                    DateTime.Now, char_1.ToString(), this.getPlayerName(entity_0), char_1, this.getPlayerID(entity_0), char_1, this.getPlayerGuid(entity_0), char_1, this.getPlayerHWID(entity_0), char_1, this.getPlayerXuid(entity_0), char_1, this.getPlayerIP(entity_0), char_1, "^7Suspect use ^1NORECOIL ^7with weapon ^1", string_106,
                    " ^7on ^1", DateTime.Now
                });
        ...
        internal void method_13(Entity entity_0, string string_106)
        {
            ...
            {
                string str = string.Concat(new object[] { 
                    DateTime.Now, char_1.ToString(), this.getPlayerName(entity_0), char_1, this.getPlayerID(entity_0), char_1, this.getPlayerGuid(entity_0), char_1, this.getPlayerHWID(entity_0), char_1, this.getPlayerXuid(entity_0), char_1, this.getPlayerIP(entity_0), char_1, "^7Suspect use ^1AIMBOT ^7with weapon ^1", string_106,
                    " ^7on ^1", DateTime.Now
                });
                writer.WriteLine(str);
                writer.Close();
        ...
        internal void method_14(Entity entity_0)
        {
            ...
            {
                string str = string.Concat(new object[] { DateTime.Now, char_1.ToString(), this.getPlayerName(entity_0), char_1, this.getPlayerID(entity_0), char_1, this.getPlayerGuid(entity_0), char_1, this.getPlayerHWID(entity_0), char_1, this.getPlayerXuid(entity_0), char_1, this.getPlayerIP(entity_0), char_1, "^7Suspect use ^1HACK ^7on ^1", DateTime.Now });
                writer.WriteLine(str);
                writer.Close();
            }
        }
                    ...
                    if (flag)
                    {
                        if (ping > int_3)
                        {
                            ...
                            else
                            {
                                ...
                                Class75.smethod_73(this, entity, string.Concat(new object[] { "^7Detected Ping [^1", ping, "^7] Too High! - Notice Nr ^1", field, "^7/^15" }));
                            }
                        }
                        else
                        {
                    ...
                    foreach (Entity entity in list_3)
                    {
                        ...
                        if (dictionary_1.ContainsKey(str))
                        {
                            if (dictionary_1[str] != this.getPlayerName(entity))
                            {
                                ...
                                Class75.smethod_64(this, "^1" + dictionary_1[str] + " ^7ID^1 " + this.getPlayerID(entity) + " ^7changed nick:^1 " + this.getPlayerName(entity));
        ...
        private void method_2(Entity entity_0, string string_106)
        {
                        ...
                        switch (num)
                        {
                            ...
                            case 14:
                                ...
                                if ((current != null) && current.IsAlive)
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^5" + this.getPlayerName(class2.entity_0) + " ^7GodMode given to ^1" + current.Name);
                                }
                                return;
                            ...
                            case 15:
                                ...
                                if ((current != null) && current.IsAlive)
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^7Unfreeze ^1" + current.Name);
                                }
                                return;
                            ...
                            case 0x10:
                                ...
                                if ((current != null) && current.IsAlive)
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^7Freeze ^1" + current.Name);
                                }
                                return;
                            ...
                            case 0x11:
                                ...
                                if (current != null)
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^7Fly mode enabled to ^1" + current.Name);
                                }
                                return;
                            ...
                            case 0x1a:
                                if ((strArray.Length == 2) && isNum(strArray[1]))
                                {
                                    ...
                                    Class75.smethod_73(this, class2.entity_0, "^7FPS set on: ^1" + strArray[1]);
                                }
                                return;
                            ...
                            case 0x1f:
                                ...
                                if (strArray.Length != 1)
                                {
                                    ...
                                    if (current != null)
                                    {
                                        ...
                                        Class75.smethod_73(this, class2.entity_0, "^1" + current.Name + " ^7set AFK");
                                    }
                                }
                                return;
                            ...
                            case 0x20:
                                ...
                                Class75.smethod_73(this, class2.entity_0, "^1" + class2.entity_0.Name + " ^7set AFK");
                                return;

                            case 0x21:
                                class2.entity_0.Notify("menuresponse", new Parameter[] { "menu", "endround" });
                                Class75.smethod_64(this, "^7Round Ended by ^5" + class2.entity_0.Name);
                                return;
                            ...
                            case 0x23:
                                ...
                                if (current != null)
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^7FilmTweak set on ^1" + current.Name);
                                }
                                return;
                            ...
                            case 0x2a:
                                if (strArray.Length != 1)
                                {
                                    ...
                                    if (current != null)
                                    {
                                        ...
                                        Class75.smethod_158(this, class2.entity_0, "^7Degraded ^1" + this.getPlayerName(current));
                                    }
                                }
                                return;
                            ...
                            case 0x2c:
                                ...
                                Class75.smethod_73(this, class2.entity_0, "^1Enter the name of the script. ^7example: !load MyAdmin.dll");
                                return;
                            ...
                            case 0x2d:
                                ...
                                Class75.smethod_73(this, class2.entity_0, "^1Enter the name of the script. ^7example: !unload MyAdmin.dll");
                                return;
                            ...
                            case 0x3b:
                                ...
                                Class75.smethod_158(this, class2.entity_0, "^1" + this.getPlayerName(class2.entity_0) + " ^7Password Disabled!");
                                goto Label_2532;
                            ...
                            case 0x40:
                                ...
                                Class75.smethod_10(this, string.Concat(new object[] { "^7Jump = ^5", int_5, "^7 - Speed = ^5", int_6, "^7 - Gravity = ^5", int_7 }));
                            ...
                            case 0x4a:
                                if (strArray.Length == 2)
                                {
                                    ...
                                    if (current != null)
                                    {
                                        ...
                                        Class75.smethod_73(this, class2.entity_0, "^1" + this.getPlayerName(current) + " ^7Muted!");
                                    }
                                }
                                return;
                            ...
                            case 0x4b:
                                if (strArray.Length == 2)
                                {
                                    ...
                                    if (current != null)
                                    {
                                        ...
                                        Class75.smethod_73(this, class2.entity_0, "^5" + this.getPlayerName(current) + " ^7UnMuted!");
                                    }
                                }
                                return;
                            ...
                            case 0x5b:
                                ...
                                Class75.smethod_64(this, "^1Server Password Disabled!");
                                bool_8 = false;
                                parser = new IniParser(string_84 + string_47);
                                parser.AddSetting("PASSWORD_ACCESS_SERVER", "Status_Password_Script", "false");
                                parser.SaveSettings();
                                Class75.smethod_64(this, "^1Restart Map in 2 second...");
                                Class75.smethod_6(this, "map_restart", 0x7d0);
                                return;
                            ...
                            case 0x5d:
                                Class75.smethod_73(this, class2.entity_0, "^7Current Password is: ^1" + string_16);
                                return;

                            case 0x5e:
                                Class75.smethod_73(this, class2.entity_0, "^7Password Status: ^1" + bool_8);
                                return;
                            ...
                            case 0x67:
                                ...
                                bool_48 = false;
                                Class75.smethod_64(this, "^1Votation canceled!");
                                return;
                            ...
                            case 0x6b:
                                Class75.smethod_73(this, class2.entity_0, string.Concat(new object[] { "^7It's ^1", DateTime.Now.ToShortTimeString(), "^7 o'clock of ^1", DateTime.Now.Day, "^7/^1", DateTime.Now.Month, "^7/^1", DateTime.Now.Year }));
                                return;
                            ...
                            case 0x70:
                            case 0x71:
                                Class75.smethod_73(this, class2.entity_0, "^7MyAdmin v4.1 by ^5MH11 ^7- Info: ^1www.naabclub.ir");
                                return;
                            ...
                            case 0x77:
                                if (strArray.Length != 1)
                                {
                                    ...
                                    Class75.smethod_73(this, class2.entity_0, "^1Vote active... Wait till the end!");
                                }
                                return;
                            ...
                            case 120:
                                if (strArray.Length != 1)
                                {
                                    ...
                                    Class75.smethod_64(this, "^5" + this.getPlayerName(class2.entity_0) + " ^7manual login as ^5Owner");
                                }
                                return;
                            ...
                            case 0x79:
                                if (((strArray.Length != 1) && (string_3 != null)) && (string_3 != "null"))
                                {
                                    ...
                                    Class75.smethod_73(this, class2.entity_0, "^5" + this.getPlayerName(class2.entity_0) + " ^7control enabled!");
                                }
                                return;
                            ...
                            case 0x7a:
                                if ((strArray.Length == 2) && isNum(strArray[1]))
                                {
                                    ...
                                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set on ^165");
                                }
                                return;
                            ...
                            case 0x7c:
                                ...
                                Class75.smethod_73(this, class2.entity_0, "^7Your stats: Kill ^1" + strArray3[3].ToString() + "^7, Dead ^1" + strArray3[4].ToString() + "^7, Skill ^1" + strArray3[5].ToString() + "^7, HeadShot ^1" + strArray3[6].ToString() + "^7, Moab ^1" + strArray3[7].ToString());
                                return;
            ...
            Label_096B:
                if (strArray.Length == 1)
                {
                    ...
                    {
                        Class75.smethod_73(this, class2.entity_0, "^1Login required before deleting the registration!");
                    }
                }
                return;
            Label_0A6A:
            ...
            Label_0C8B:
                ...
                Class75.smethod_73(this, class2.entity_0, "^7Weapon  given to ^1" + this.getPlayerName(current));
                return;
            Label_0CBF:
            ...
            Label_0CD5:
                if (strArray.Length != 1)
                {
                    if (strArray[1] == "all")
                    {
                        foreach (Entity entity in list_3)
                        {
                            if (entity.IsAlive)
                            {
                                ...
                                entity.Call("iprintlnbold", new Parameter[] { "^1" + this.getPlayerName(entity) + " ^7Ammo received!!!" });
                            }
                        }
                    }
                    else
                    {
                        ...
                        if ((current != null) && current.IsAlive)
                        {
                            ...
                            current.Call("iprintlnbold", new Parameter[] { "^1" + current.Name + " ^7Ammo received!!!" });
                            Class75.smethod_158(this, class2.entity_0, "^7Ammo given to ^1" + current.Name);
                        }
                    }
                }
                else
                {
                    ...
                    Class75.smethod_158(this, class2.entity_0, "^1" + this.getPlayerName(class2.entity_0) + " ^7Ammo received!!!");
                }
                return;
            Label_0F56:
                ...
                if (strArray.Length == 3)
                {
                    ...
                    if ((current != null) && current.IsAlive)
                    {
                        ...
                        if ((entity5 != null) && current.IsAlive)
                        {
                            ...
                            Class75.smethod_158(this, class2.entity_0, "^1" + this.getPlayerName(current) + " ^7teleported to ^5" + this.getPlayerName(entity5));
                        }
                    }
                }
                return;
            ...
            Label_1441:
                ...
                parser.SaveSettings();
                Class75.smethod_64(this, "^5knife Enabled!");
                return;
            Label_14D7:
                if (strArray[1] == "40")
                {
            ...
            Label_176C:
                ...
                Class75.smethod_73(this, class2.entity_0, "^7Server name set to: ^1" + str4.Trim());
                return;
            Label_1842:
                if (num7 > 1)
                {
            ...
            Label_1873:
                ...
                return;
            Label_194A:
                Class75.smethod_73(this, class2.entity_0, "^1You can not set Afk in infect mode");
                return;
            Label_1A09:
                Class75.smethod_73(this, class2.entity_0, "^1You can not set Afk in infect mode");
                return;
            Label_1AFF:
                ...
                return;
            Label_1B59:
                Class75.smethod_73(this, class2.entity_0, "^1Bots are not compatible with TeknoMW3");
                return;
            Label_1BD6:
                Class75.smethod_73(this, class2.entity_0, "^1Error - Player is same level or higher!");
                return;
            ...
            Label_1C99:
                if (strArray.Length > 2)
                {
                    ...
                    Class75.smethod_158(this, class2.entity_0, "^1" + this.getPlayerName(class2.entity_0) + " ^7Parameters are Set!");
                }
                return;
            Label_1DB6:
            ...
            Label_24C1:
                ...
                Class75.smethod_158(this, class2.entity_0, "^5" + this.getPlayerName(class2.entity_0) + " ^7Password Enabled!");
                goto Label_2532;
            Label_24FF:
                Class75.smethod_6(this, "g_password \"\"", 0);
                Class75.smethod_158(this, class2.entity_0, "^1" + this.getPlayerName(class2.entity_0) + " ^7Password Disabled!");
            ...
            Label_255C:
                using (enumerator = list_3.GetEnumerator())
                {
                    while (enumerator.MoveNext())
                    {
                        ...
                        if (bool_49)
                        {
                            current.SetClientDvar("r_filmUseTweaks", "1");
                            current.SetClientDvar("r_filmTweakEnable", "1");
                            current.SetClientDvar("r_filmTweakLightTint", "0 0.2 1");
                            current.SetClientDvar("r_filmTweakDarkTint", "0 0.125 1");
                            current.SetClientDvar("r_filmtweakbrightness", "0");
                            current.SetClientDvar("r_glowTweakEnable", "1");
                            current.SetClientDvar("r_glowUseTweaks", "1");
                            current.SetClientDvar("r_glowTweakRadius0", "5");
                            current.SetClientDvar("r_glowTweakBloomIntensity0", "0.5");
                            current.SetClientDvar("r_fog", "0");
                        }
                        else
                        {
                            current.SetClientDvar("r_filmUseTweaks", "0");
                            current.SetClientDvar("r_filmTweakEnable", "0");
                            current.SetClientDvar("r_glowTweakEnable", "0");
                            current.SetClientDvar("r_glowUseTweaks", "0");
                            current.SetClientDvar("r_fog", "1");
                        }
                    }
                }
                Class75.smethod_158(this, class2.entity_0, string.Concat(new object[] { "^5", this.getPlayerName(class2.entity_0), " ^7night set ^1", bool_49 }));
                return;
            Label_2678:
                Class75.smethod_34(this, strArray[2], class2.entity_0, current);
            Label_268A:
                Class75.smethod_73(this, class2.entity_0, "^1" + this.getPlayerName(current) + " ^7killed!");
                return;
            Label_26B2:
            ...
            Label_26DA:
                bool_1 = true;
            Label_26E0:
                Class75.smethod_73(this, class2.entity_0, "^7Vote status changed in: ^1" + bool_1);
                return;
            Label_2717:
                bool_50 = true;
            Label_271D:
                Class75.smethod_73(this, class2.entity_0, "^7Chat status changed in: ^1" + bool_50);
                return;
            Label_2871:
            ...
            Label_29EB:
                ...
                return;
            Label_2AA7:
                Class75.smethod_73(this, class2.entity_0, "^1Error - TempBan minutes limit for your group is " + int_11);
                return;
            Label_2AE7:
                str4 = str4 + " " + strArray2[num3];
                num3++;
            ...
            Label_3748:
                ...
                Class75.smethod_73(this, class2.entity_0, "^7Mess sent to ^1" + this.getPlayerName(current));
                return;
            Label_37B2:
                Class75.smethod_73(this, class2.entity_0, "^1There are no active votings");
                return;
            Label_37D3:
                if (strArray.Length == 1)
                {
                    ...
                    {
                        Class75.smethod_73(this, class2.entity_0, "^1The command will be active as soon as you start the match");
                    }
                }
                return;
            Label_3A2F:
            ...
            Label_3BA6:
                ...
                {
                    Class75.smethod_73(this, class2.entity_0, "^1There Must pass at least 1 minutes after the last votation or the begin of the match");
                }
                else
                {
            ...
            Label_3E1D:
                if (num12 == 70)
                {
                    ...
                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set on ^170");
                }
                else if (num12 == 0x4b)
                {
                    class2.entity_0.SetClientDvar("cg_fov", "75");
                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set to ^175");
                }
                else if (num12 == 80)
                {
                    class2.entity_0.SetClientDvar("cg_fov", "80");
                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set on ^180");
                }
                else if (num12 == 0x55)
                {
                    class2.entity_0.SetClientDvar("cg_fov", "85");
                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set on ^185");
                }
                else if (num12 == 90)
                {
                    class2.entity_0.SetClientDvar("cg_fov", "90");
                    Class75.smethod_158(this, class2.entity_0, "^7 Fov Set on ^190");
                }
                else
                {
                    Class75.smethod_158(this, class2.entity_0, "^7 Value ^1" + num12 + "^7 is not valid. Choose from 65-70-75-80-85-90!");
                }
                return;
            Label_3F5A:
                if (DBPlayerlvl[num4] != "")
            ...
            Label_3F7B:
                ...
                goto Label_3FA1;
            Label_3F8D:
                Class75.smethod_73(this, class2.entity_0, "^1Command already in use!");
                flag = false;
            Label_3FA1:
                if (flag)
                {
                    ...
                    if (bool_41)
                    {
                        if ((this.getPlayerPsw(class2.entity_0) == 1) && (this.getPlayerPswOk(class2.entity_0) == 1))
                        {
                            ...
                            Class75.smethod_73(this, class2.entity_0, "^5" + this.getPlayerName(class2.entity_0) + " ^7registered as ^5" + DBNomeGruppi[DBNomeGruppi.Count - 1]);
                        }
                        else
                        {
                            Class75.smethod_73(this, class2.entity_0, "^7You must first register your account... use function ^1!psw");
                        }
                    }
                    else
                    {
            ...
            Label_41A9:
                ...
                if (current != null)
                {
                    ...
                    if (strArray3 != null)
                    {
                        Class75.smethod_73(this, class2.entity_0, "^7Player ^1" + this.getPlayerName(current) + " ^7stats: Kill ^1" + strArray3[3].ToString() + "^7, Dead ^1" + strArray3[4].ToString() + "^7, Skill ^1" + strArray3[5].ToString() + "^7, HeadShot ^1" + strArray3[6].ToString() + "^7, Moab ^1" + strArray3[7].ToString());
                    }
                    else
                    {
                    ...
                    for (int i = 0; i < strArray.Length; i++)
                    {
                        ...
                        if (str2.StartsWith(str))
                        {
                            ...
                            if (flag3)
                            {
                                ...
                                {
                                    string[] strArray3 = new string[] { "^7[^1", this.getPlayerName(entity_0), "^7] Detected Alias (^5", str3.TrimStart(new char[] { char_1 }), "^7)" };
        ...
        internal void method_23(Entity entity_0, Entity entity_1, int int_31, string string_106)
        {
            using (StreamWriter writer = new StreamWriter(string_85 + string_54, true))
            {
                ...
                if (entity_0 != null)
                {
                    Class75.smethod_73(this, entity_0, string.Concat(new object[] { "^1", this.getPlayerName(entity_1), " ^1added to the TempBan list for ", int_31, "min" }));
        ...
        private void method_24(Entity entity_0, string string_106)
        {
            if (System.IO.File.Exists(string_85 + string_54))
            {
                ...
                Label_00C2:
                    flag2 = false;
                    flag = true;
                    Class75.smethod_73(this, entity_0, "^7Player ^1" + strArray2[1] + "^7[^1" + strArray2[2] + "^7] successfully UnBanned!");
                    goto Label_0150;
                Label_010A:
                    flag2 = false;
                    flag = true;
        ...
        internal void method_25(Entity entity_0, Entity entity_1, string string_106)
        {
            using (StreamWriter writer = new StreamWriter(string_85 + string_55, true))
            {
                ...
                if (entity_0 != null)
                {
                    Class75.smethod_73(this, entity_0, "^1" + this.getPlayerName(entity_1) + "^7 added to the PermBan list!");
            ...
            if (string_107 == "add")
            {
                ...
                if (player != null)
                {
                    ...
                    using (writer = new StreamWriter(string_85 + string_64, true))
                    {
                        ...
                        if (entity_0 != null)
                        {
                            Class75.smethod_73(this, entity_0, "^1" + this.getPlayerName(player) + " ^7added to the Player Hack list!");
                        }
                        return;
                    }
                }
                Class75.smethod_73(this, entity_0, "^1Player not found! Use ID");
            ...
            else if (string_107 == "del")
            {
                if (System.IO.File.Exists(string_85 + string_64))
                {
                    ...
                    Label_023E:
                        flag2 = false;
                        flag = true;
                        Class75.smethod_73(this, entity_0, "^7Report Player ^1" + strArray2[0] + "^7[^1" + strArray2[1] + "^7] successfully deleted!");
                    Label_0285:
                        if (flag2)
                        {
                            using (writer = new StreamWriter(string_85 + string_64, true))
        ...
        private void method_30()
        {
            ...
            else if (string_2.StartsWith("pl"))
            {
                str = "PlusIW5_Server";
            }
            else if (string_2.StartsWith("stm"))
            {
                str = "iw5mp_server";
            }
            ...
            using (StreamWriter writer = new StreamWriter("riavvia.bat", true))
            {
                ...
                string str4 = "TASKKILL /F /IM " + string_0 + ".exe /T";
                string str5 = "TIMEOUT /T 2 /NOBREAK";
                string str6 = "start /B /MIN " + string_0 + ".exe +set net_queryPort " + num.ToString() + " +set net_port " + num2.ToString() + " +set net_masterServerPort " + num3.ToString() + " +set sv_config \"server.cfg\" +start_map_rotate +set dedicated 2";
            ...
            try
            {
                ...
                if (((class3.string_0[0].Contains("map") || class3.string_0[0].Contains("mod")) || class3.string_0[0].Contains("kick")) || class3.string_0[0].Contains("ban"))
                {
                    ...
                    if (class2.entity_0 != null)
                    {
                        ...
                        Class75.smethod_64(this, "^1" + this.getPlayerName(class2.entity_0) + " ^7has requested a vote");
                    ...
                    {
                        hudElem_0.SetText("^7Vote Change ^1Map ^5" + Class75.smethod_88(this, class3.string_0[1]) + "^7?");
                    }
                    else if (class3.string_0[0].Contains("mod"))
                    {
                        hudElem_0.SetText("^7Vote Change ^1Mode ^5" + class3.string_0[1] + "^7?");
                    }
                    else if (class3.string_0[0].Contains("kick"))
                    {
                        hudElem_0.SetText("^7Vote ^1kick ^5" + class2.string_0 + "^7?");
                    }
                    else if (class3.string_0[0].Contains("ban"))
                    {
                        hudElem_0.SetText("^7Vote ^1TempBan ^5" + class2.string_0 + "^7?");
                    }
                    hudElem_0.Alpha = 1f;
                    hudElem_1.Alpha = 1f;
                    if (function == null)
        ...
        internal void method_52(Entity entity_0)
        {
            ...
            if (bool_15)
            {
                //Class75.smethod_73(this, class2.entity_0, "^7You are the player number ^1#" + int_29);
            ...
            if (list_3.Count > 0)
            {
                ...
                switch (num)
                {
                    ...
                    case 5:
                        ...
                        {
                            Class75.smethod_64(this, "^7" + DBNomeGruppi[num2] + " OnLine: ^5" + this.GruppiOnline(num2));
                        }
                        goto Label_0142;
                }
                if ((num == 6) && bool_32)
                ...
                else if ((num == 7) && bool_16)
                {
                    if (string_93.Contains("inf"))
                    {
                        if (bool_33)
                        {
                            Class75.smethod_64(this, "^7Use ^1!register ^7to activate your XlrStats");
                        }
                    }
                    else
                    {
                ...
                {
                    Class75.smethod_64(this, "^7Protect your account, use ^1!psw <password> <repeatpassword> ^7to register it");
                }
            ...
            if (System.IO.File.Exists(string_88 + string_57))
            {
                ...
                Label_0085:
                    ...
                    using (StreamWriter writer = new StreamWriter(string_85 + string_54, true))
                    {
                        writer.WriteLine(string.Concat(new object[] { DateTime.Now, char_2.ToString(), int_31, char_1, strArray[i] }));
                        writer.Close();
                        Class75.smethod_64(this, string.Concat(new object[] { "^7Player ^1", strArray2[0], " ^7TempBanned for ", int_31, "min!" }));
                    }
                Label_0149:
                    if (flag)
                    {
        ...
        public override BaseScript.EventEat OnSay3(Entity player, BaseScript.ChatType type, string name, ref string message)
        {
            try
            {
                ...
                if (message.StartsWith("!"))
                {
                    ...
                    {
                        Class75.smethod_73(this, player, "^1Higher player in this game, some commands can not be activated!");
                        return BaseScript.EventEat.EatGame;
                    }
                    if ((strArray[0] == ("!" + string_16)) && this.IsJoinUsers(player))
                    {
                        ...
                        Class75.smethod_73(this, player, "^5ENJOY ^7- By ^5MH11^7!!!");
                        return BaseScript.EventEat.EatGame;
                    }
                    if (strArray[0] == "!psw")
                    {
                        ...
                        if (strArray.Length == 2)
                        {
                            if (this.getPlayerPswOk(player) == 0)
                            {
                                ...
                                {
                                    Class75.smethod_73(this, player, "^1Username not registered!");
                                    Class75.smethod_73(this, player, "^7Use ^1!psw password repeatpassword ^7to register username.");
                                }
                            }
                            else
                            {
                                Class75.smethod_73(this, player, "^1User is already authenticated!");
                            }
                        }
                        else if (strArray.Length == 3)
                        {
                            ...
                            {
                                Class75.smethod_73(this, player, "^1Username already registered!");
                            }
                        }
                        return BaseScript.EventEat.EatGame;
                    }
            ...
            Label_0431:
                if (((player.GetField<int>("Mute") == 1) || !bool_50) && (((this.getPlayerLevel(player) < 2) && (type == BaseScript.ChatType.All)) && (this.getPlayerAccess(player) != 1)))
                {
                    ...
                    {
                        Class75.smethod_158(this, player, "^1" + this.getPlayerName(player) + " ^7you have been mutated!");
                    }
                    return BaseScript.EventEat.EatGame;
                }
            Label_049E:
        ...
        internal sealed class Class13
        {
            ...
            public void method_0()
            {
                ...
                Class75.smethod_73(this.serverControll_0, this.entity_0, "^7You are ^5Staff ^7you don't have to enter it!");
            }
        ...
        internal sealed class Class16
        {
            ...
            public void method_0()
            {
                Class75.smethod_73(this.class15_0.serverControll_0, this.class15_0.entity_0, "^1" + ServerControll.DBComandilvl[this.int_0]);
            }
        }
        ...
        internal sealed class Class17
        {
            ...
            public void method_0(Entity entity_0)
            {
                Class75.smethod_73(this.class15_0.serverControll_0, entity_0, "^1" + this.string_0);
            }
        }
        ...
        internal sealed class Class19
        {
            ...
            public bool method_0(Entity entity_0)
            {
                ...
                Class75.smethod_158(this.class18_0.serverControll_0, this.class18_0.entity_0, "^7Use ^1!psw password ^7to login, kick in ^1" + this.int_2 + " ^7seconds");
                if (this.int_2.ToString().EndsWith("0"))
                {
                    Class75.smethod_64(this.class18_0.serverControll_0, "^7Player ^1" + this.class18_0.serverControll_0.getPlayerName(this.class18_0.entity_0) + " ^7awaiting authentication...");
                }
                if (this.int_2 < 1)
                {
                ...
                else
                {
                    ...
                    {
                        Class75.smethod_73(this.class18_0.serverControll_0, this.class18_0.entity_0, "^1" + this.class18_0.serverControll_0.getPlayerName(this.class18_0.entity_0) + " ^7- The user name is protected, enter the password!");
                    }
        ...
        internal sealed class Class20
        {
            ...
            public void method_0(Entity entity_2)
            {
                if (this.serverControll_0.getPlayerAccess(entity_2) == 1)
                {
                    if (!entity_2.IsAlive)
                    {
                        Class75.smethod_158(this.serverControll_0, this.entity_1, "^1You must be alive to use the graphical menu!");
                    }
                    else
                    {
                        this.int_0 = 0;
        ...
        internal sealed class Class27
        {
            ...
            public bool method_0()
            {
                if ((this.int_0 < this.string_0.Length) && (this.string_0[this.int_0] != ""))
                {
                    ...
                    Class75.smethod_73(this.class26_0.serverControll_0, this.class26_0.entity_0, "^5" + this.string_1[0] + "^7[^5" + this.string_1[1] + "^7]");
                    this.int_0++;
                    return true;
                }
                return false;
        ...
        internal sealed class Class28
        {
            ...
            public void method_0(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7Nick: ^1" + this.serverControll_0.getPlayerName(this.entity_0));
            }

            public void method_1(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7Group Level: ^1" + ServerControll.DBNomeGruppi[this.serverControll_0.getPlayerLevel(this.entity_0)]);
            }

            public void method_10(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7GPS: Connect from [^1" + this.serverControll_0.lookupIP(this.serverControll_0.GetIPAddress(this.entity_0.EntRef).ToString()) + "^7]");
            }

            public void method_2(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7ClanTag: ^1" + this.serverControll_0.getPlayerTag(this.entity_0));
            }

            public void method_3(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7ID: ^1" + this.serverControll_0.getPlayerID(this.entity_0));
            }

            public void method_4(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7GUID: ^1" + this.serverControll_0.getPlayerGuid(this.entity_0));
            }

            public void method_5(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7HWID: ^1" + this.serverControll_0.getPlayerHWID(this.entity_0));
            }

            public void method_6(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7XUID: ^1" + this.serverControll_0.getPlayerXuid(this.entity_0));
            }

            public void method_7(Entity entity_1)
            {
                Class75.smethod_73(this.serverControll_0, entity_1, "^7IP: ^1" + this.serverControll_0.getPlayerIP(this.entity_0));
            }
            ...
            public void method_8(Entity entity_1)
            {
                ...
                {
                    Class75.smethod_73(this.serverControll_0, entity_1, "^7PSW: ^5Player Registered");
                }
                else
                {
                    Class75.smethod_73(this.serverControll_0, entity_1, "^7PSW: ^1Player Not Registered");
                }
            }
                    ...
                    if (class2.entity_0.HasField("LPCamp"))
                    {
                        ...
                        if (field.DistanceTo2D(class2.entity_0.Origin) < 100f)
                        {
                            ...
                            if (num2 <= this.int_0)
                            {
                                ...
                                Class75.smethod_158(this.serverControll_0, class2.entity_0, string.Concat(new object[] { "^7[^1", num2, "^7/^1", this.int_0, "^7] ^1No Camp!!! ^7- If you do not move you are ", str }));
                            }
        ...
        internal sealed class Class39
        {
            ...
            label_8:
                ...
                else
                {
                    ...
                    if ((!this.serverControll_0.getPlayerHWID(entity_1).Contains("0000000000") ? 1 : (!ServerControll.string_2.StartsWith("pl") ? 1 : 0)) == 0)
                    {
                    ...
                    else
                    {
                        ...
                        for (int index = 0; index < ServerControll.string_72.Length; ++index)
                        {
                            if (entity_1.Name.ToLower().Contains(ServerControll.string_72[index]))
                            {
                                ...
                                Class75.smethod_6(this.serverControll_0, "dropclient " + (object)this.entity_0.Call<int>("getentitynumber", new Parameter[0]) + " \"^1Change your Nick, characters (^7 , ; = > § ^1) not permitted!\"", 0);
                                return;
                            }
                        }
            ...
            public bool method_0()
            {
                if ((this.int_0 < this.string_0.Length) && (this.string_0[this.int_0] != ""))
                {
                    ...
                    if (span.TotalMinutes < num)
                    {
                        ...
                        Class75.smethod_73(this.class54_0.serverControll_0, this.class54_0.entity_0, string.Concat(new object[] { "^7[^1", this.int_0, "^7] ^5", this.string_1[1], "^7[^1", this.string_1[2], "^7] banned for other ", num2, "min" }));
                    }
                    this.int_0++;
                    return true;
                }
        ...
        private sealed class Class61
        {
            ...
            public bool method_0()
            {
                ...
                this.int_0--;
                Class75.smethod_64(this.serverControll_0, "^5Server will be restarted in " + this.int_0 + "s");
                return true;
            }
        }
        ...
        internal sealed class Class65
        {
            ...
            public bool method_0(Entity entity_1)
            {
                ...
                {
                    Class75.smethod_73(this.serverControll_0, this.entity_0, "^7" + ServerControll.DBNomeGruppi[this.int_0] + " OnLine: ^5" + this.serverControll_0.GruppiOnline(this.int_0));
                    this.int_0--;
                }
                else
                {
        ...
        internal sealed class Class66
        {
            ...
            public bool method_0(Entity entity_1)
            {
                if ((ServerControll.DBNomeGruppi[this.int_0] != "null") && (ServerControll.DBNomeGruppi[this.int_0] != ""))
                {
                    Class75.smethod_73(this.serverControll_0, this.entity_0, string.Concat(new object[] { "^7Level Group ^1", this.int_0, "^7 = ^1", ServerControll.DBNomeGruppi[this.int_0] }));
                    this.int_0--;
                }
                else
                {
        ...
        internal sealed class Class68
        {
            ...
            public bool method_0()
            {
                foreach (Entity entity in ServerControll.list_3)
                {
                    ...
                    {
                        Class75.smethod_73(this.class67_0.serverControll_0, entity, "^7Available to download the new version ^1MyAdmin " + this.string_1 + " ^7Link: ^1" + this.string_0);
                    }
                }
                ServerControll controll = this.class67_0.serverControll_0;
                Class75.smethod_84("^7Available to download the new version ^1MyAdmin " + this.string_1 + "\n " + this.string_0, controll);
                return true;
            }
        }
            ...
            public bool method_0()
            {
                ...
                if (ServerControll.int_20 >= ServerControll.int_16)
                {
                    ...
                    if (num2 <= num)
                    {
                        ...
                        Class75.smethod_64(this.class69_0.serverControll_0, "^1Negative vote - Voters must exceed half of online gamers!");
                        return false;
                    }
                ...
                ServerControll.hudElem_1.SetText(string.Concat(new object[] { "^5!y ^7or ^1!n ^7- [^5", ServerControll.int_17, "^7/^1", ServerControll.int_18, "^7] Conclusion ^1", ServerControll.int_19, "s" }));
                return true;
            }
