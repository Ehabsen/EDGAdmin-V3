namespace ns1
{
    ...
    internal sealed class Class75
    {
        ...
        {
            // --- Movement & Bob (Removed for maximum stability) ---
            serverControll_0.Call("setdvar", new Parameter[] { "bg_weaponBobMax", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_viewBobMax", "0" });
            ...
            // --- Sniper Sway & Idle Movement (Crucial for iScope) ---
            serverControll_0.Call("setdvar", new Parameter[] { "bg_weaponIdleSwayScaleSelf", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_weaponIdleSwayScaleSprinting", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_weaponIdleSwayRate", "0" });

            // --- Physics & Damage Handling ---
            ...
            // --- ViewKick / Flinch (Eliminated for accurate return fire) ---
            serverControll_0.Call("setdvar", new Parameter[] { "bg_viewKickRandom", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_viewKickMin", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_viewKickScale", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "bg_viewKickMax", "0" });

            // --- Network & Performance ---
            serverControll_0.Call("setdvar", new Parameter[] { "sv_network_fps", "100" });

            // --- iScope Perks & Handling ---
            ...
            serverControll_0.Call("setdvar", new Parameter[] { "perk_bulletPenetrationMultiplier", "2.0" }); // Buffed for collateral hits
            serverControll_0.Call("setdvar", new Parameter[] { "perk_quickDrawSpeedScale", "1.75" });        // Faster ADS
            serverControll_0.Call("setdvar", new Parameter[] { "perk_weapSpreadMultiplier", "0.01" });      // Tight hipfire for no-scopes
            ...
            // --- Adjusted iScope S&D Scoring ---
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_kill", "10" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_headshot", "20" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_assist", "1" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_plant", "5" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_defuse", "5" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_teamkill", "0" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_capture", "5" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_defend", "2" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_defend_assist", "1" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_assault", "5" });
            serverControll_0.Call("setdvar", new Parameter[] { "scr_sd_score_assault_assist", "2" });
        ...
        /* private scope */internal static void smethod_106(string string_0, ServerControll serverControll_0, string string_1)
        {
            ...
            catch (Exception exception)
            {
                ...
                smethod_84("Error - Problem automatic updates, check for updates manually on the official page: edg-tkg.de/", serverControll_0);
        ...
        /* private scope */internal static void smethod_187(ServerControll serverControll_0)
        {
            try
            {
                if (ServerControll.list_2.Count == 0)
                {
                    ...
                    string str2 = ("edg-tkg.de/script/servercontroll/stats.php?inf=" + str).Replace(" ", "_").Replace("&", "_").Replace("#", "_").Replace("\"", "_");
