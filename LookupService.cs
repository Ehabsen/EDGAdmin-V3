...
public class LookupService
{
    ...
    public Country getCountry(long ipAddress)
    {
        ...
        int index = Class75.smethod_212(this, ipAddress) - int_1;
        if (index == 0)
        {
            return country_0;
        }
    ...
    {
       return this.getCountry(Class75.smethod_1(ipAddress.GetAddressBytes()));
    }
    ...
    public Country getCountry(string ipAddress)
    {
        ...
        return this.getCountry(Class75.smethod_1(address.GetAddressBytes()));
    }
    ...
    public Country getCountryV6(IPAddress ipAddress)
    {
        ...
        int index = Class75.smethod_208(this, ipAddress) - int_1;
        if (index == 0)
        {
            return country_0;
        }
    ...
    public int getID(long ipAddress)
    {
        ...
        return (Class75.smethod_212(this, ipAddress) - this.int_3[0]);
    }

    public int getID(IPAddress ipAddress)
    {
       return this.getID(Class75.smethod_1(ipAddress.GetAddressBytes()));
    }
    ...
    public int getID(string ipAddress)
    {
        ...
        return this.getID(Class75.smethod_1(address.GetAddressBytes()));
    }
    ...
    public Location getLocation(long ipnum)
    {
        ...
        {
            int num8;
            int num5 = Class75.smethod_212(this, ipnum);
            ...
            location.countryCode = string_0[Class75.smethod_196(destinationArray[0])];
            location.countryName = string_1[Class75.smethod_196(destinationArray[0])];
            startIndex++;
            ...
            {
                num3 += Class75.smethod_196(destinationArray[startIndex + num8]) << (num8 * 8);
            }
            location.latitude = (((float) num3) / 10000f) - 180f;
            startIndex += 3;
            for (num8 = 0; num8 < 3; num8++)
            {
                num4 += Class75.smethod_196(destinationArray[startIndex + num8]) << (num8 * 8);
            }
            ...
            for (num8 = 0; num8 < 3; num8++)
            {
                num10 += Class75.smethod_196(destinationArray[startIndex + num8]) << (num8 * 8);
            }
            location.metro_code = location.dma_code = num10 / 0x3e8;
            location.area_code = num10 % 0x3e8;
        }
        catch (IOException)
        {
    ...
    {
       return this.getLocation(Class75.smethod_1(addr.GetAddressBytes()));
    }
    ...
    public Location getLocation(string str)
    {
        ...
        return this.getLocation(Class75.smethod_1(address.GetAddressBytes()));
    }
    ...
    public Location getLocationV6(IPAddress addr)
    {
        ...
        {
            int num8;
            int num5 = Class75.smethod_208(this, addr);
            if (num5 == this.int_3[0])
            {
                return null;
            }
    ...
    public Location getLocationV6(string str)
    {
        ...
        return this.getLocationV6(address);
    }
    ...
    public string getOrg(long ipnum)
    {
        ...
        try
        {
            int num2 = Class75.smethod_212(this, ipnum);
    ...
    {
       return this.getOrg(Class75.smethod_1(addr.GetAddressBytes()));
    }
    ...
    public string getOrg(string str)
    {
        ...
        return this.getOrg(Class75.smethod_1(address.GetAddressBytes()));
    }
    ...
    public string getOrgV6(IPAddress addr)
    {
        ...
        try
        {
            int num2 = Class75.smethod_208(this, addr);
            if (num2 == this.int_3[0])
            {
                return null;
            }
    ...
    public Region getRegion(long ipnum)
    {
        ...
        {
            index = Class75.smethod_212(this, ipnum) - int_13;
        ...
        {
            index = Class75.smethod_212(this, ipnum) - int_14;
    ...
    {
       return this.getRegion(Class75.smethod_1(ipAddress.GetAddressBytes()));
    }
    ...
    public Region getRegion(string str)
    {
        ...
        return this.getRegion(Class75.smethod_1(address.GetAddressBytes()));
    }
}
